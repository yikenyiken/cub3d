...
/*   Updated: 2024/11/14 17:17:46 by yiken            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_horz_intersect_xy(t_ray *ray, double ray_angle, t_mlx *mlx)
{
	...
	while ((ray->horz_intersect_x >= 0 && ray->horz_intersect_x <= mlx->data.map_width)
		&& (ray->horz_intersect_y >= 0 && ray->horz_intersect_y <= mlx->data.map_height))
	{
...
void	set_vert_intersect_xy(t_ray *ray, double ray_angle, t_mlx *mlx)
{
	...
	while ((ray->vert_intersect_x >= 0 && ray->vert_intersect_x <= mlx->data.map_width)
		&& (ray->vert_intersect_y >= 0 && ray->vert_intersect_y <= mlx->data.map_height))
	{
